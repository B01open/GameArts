    ...
    if (COVERAGE)
        ...
        if (LCOV_TOOL)
            add_custom_target(coverage
                ...
                COMMAND ${LCOV_TOOL} -r ${CMAKE_BINARY_DIR}/coverage.info.in '/usr*' '${CMAKE_SOURCE_DIR}/deps**' '${CMAKE_SOURCE_DIR}/evmc*' ‘${CMAKE_SOURCE_DIR}/game-art*’  -o ${CMAKE_BINARY_DIR}/coverage.info
